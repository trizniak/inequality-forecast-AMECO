...
```{r varXPL_1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=13, fig.height=9}
...
```{r varXPL_2, echo=FALSE, message=FALSE, warning=FALSE, fig.width=13, fig.height=9}
...
```{r varXPL_3, echo=FALSE, message=FALSE, warning=FALSE, fig.width=13, fig.height=9}
